...
fun Step1AreaCaptureScreen(
    ...
    var previewBoundsInWindow by remember { mutableStateOf<android.graphics.Rect?>(null) }
        ...
        Box(
            modifier = Modifier
                ...
                .onGloballyPositioned { coords ->
                    ...
                    previewBoundsInWindow = android.graphics.Rect(
                        posInWindow.x.toInt(),
                        posInWindow.y.toInt(),
                        (posInWindow.x + coords.size.width).toInt(),
                        (posInWindow.y + coords.size.height).toInt()
                    )
                }
        ) {
                ...
                if (mode == ArMode.LIVE) {
                    Button(
                        ...
                        onClick = {
                            ...
                            previewBoundsInWindow?.let { bounds ->
                                PixelCopyHelper.copyFromWindow(activity, bounds) { bmp ->
                                    frozenBitmap = bmp
                                }
                            }
                        }
